...
LRESULT CALLBACK WndProc(
	...
	switch (nMsg)
	{
		...
		case WM_TRAY_DBCLK:
			...
			// for a double-click, we simply exid the application
			...
			// for right click, we show the balloon tip
				...
				// because by default (we disabled it) 
				// the balloon tip is not shown
...
int WINAPI WinMain(
	...
	// you ain't get no window t'is time
